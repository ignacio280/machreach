/* Page bootstrap — Tienda.
   Lifted from the design project's "MachReach Tienda.html" inline App(); the
   ReactDOM.createRoot call is appended by build-app.mjs, not written here. */

const PAGE_ID = "shop";
const PAGE_TITLE = "Tienda";
const PAGE_SUB = "Monedas y cosméticos";
  ...
  return (
    <div className="app">
      ...
      <div>
        ...
        <main className="page">
          <div className="col">
            <ShopHead data={data.shop} />
            <ShopBoard plus={plus} data={data.shop} />
          </div>
        </main>
      </div>
