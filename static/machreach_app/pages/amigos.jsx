/* Page bootstrap — Amigos.
   Lifted from the design project's "MachReach Amigos.html" inline App(); the
   ReactDOM.createRoot call is appended by build-app.mjs, not written here. */

const PAGE_ID = "friends";
const PAGE_TITLE = "Amigos";
const PAGE_SUB = "Tu grupo de estudio";
  ...
  return (
    <div className="app">
      ...
      <div>
        ...
        <main className="page">
          <div className="col">
            <FriendsHero data={data.friends} />
            <FriendsPanels data={data.friends} />
          </div>
        </main>
      </div>
