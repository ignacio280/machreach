/* Page bootstrap — Herramientas.
   Lifted from the design project's "MachReach Herramientas.html" inline App();
   the ReactDOM.createRoot call is appended by build-app.mjs, not written here. */

const PAGE_ID = "tools";
const PAGE_TITLE = "Herramientas";
const PAGE_SUB = "Flashcards y quizzes";
    ...
    <div className="app">
      ...
      <div>
        ...
        <main className="page">
          <div className="col">
            <ToolsHead />
            <ToolsBoard plus={plus} data={data.tools} />
          </div>
        </main>
      </div>
