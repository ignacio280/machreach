...
function Pricing() {
  ...
  const tiers = [
    ...
    },
    {
      ...
      features: ["Todo lo de Free", "100 generaciones IA combinadas al mes", "Quizzes y flashcards comparten el cupo", "Mas ensayos y analitica avanzada", "Streak Insurance+ y cosmeticos PLUS"],
