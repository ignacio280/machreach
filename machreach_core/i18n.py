...
SPANISH_TO_EN_VISIBLE.update({
    ...
    "Sube un PDF y genera quizzes ilimitados al instante. Plus sin límites diarios.": "Upload a PDF and generate unlimited quizzes instantly. Plus has no daily limits.",
    "Sube un PDF y genera quizzes ilimitados al instante. Plus sin limites diarios.": "Upload a PDF and generate unlimited quizzes instantly. Plus has no daily limits.",
