...
BANNERS = {
    ...
    "codex_solar": {"name": "Solar Command (PLUS)", "price_coins": 1100, "xp_required": 0, "plus_only": True,
                    "animated": True, "anim_class": "bnr-anim-molten",
                    "css": "radial-gradient(circle at 78% 35%, rgba(255,255,255,.95) 0 2%, rgba(254,240,138,.85) 3%, rgba(249,115,22,.42) 16%, transparent 34%), radial-gradient(circle at 18% 82%, rgba(251,146,60,.36), transparent 30%), linear-gradient(110deg,#190A05 0%,#7C2D12 32%,#F97316 58%,#FACC15 76%,#FFF7ED 100%)"},
    "codex_midnight": {"name": "Midnight Library", "price_coins": 650, "xp_required": 1800,
                       "css": "linear-gradient(90deg, rgba(255,122,61,.08) 0 1px, transparent 1px 48px), radial-gradient(circle at 16% 26%, rgba(255,122,61,.25), transparent 18%), radial-gradient(circle at 84% 70%, rgba(91,70,148,.36), transparent 24%), linear-gradient(135deg,#080A12 0%,#1A1A1F 42%,#2D2431 72%,#5B4694 100%)"},
    "codex_aurora": {"name": "Exam Aurora (Animated)", "price_coins": 900, "xp_required": 2400,
                     "animated": True, "anim_class": "bnr-anim-aurora-borealis",
                     "css": "radial-gradient(ellipse at 18% 80%, rgba(0,155,114,.45), transparent 36%), radial-gradient(ellipse at 72% 22%, rgba(255,122,61,.34), transparent 36%), radial-gradient(ellipse at 48% 52%, rgba(124,58,237,.28), transparent 44%), linear-gradient(135deg,#04130F 0%,#06352A 38%,#132039 68%,#30144A 100%)"},
...
FLAGS = {
    ...
    "codex_solar_flag": {"name": "Solar Command Flag (PLUS)", "price_coins": 900, "xp_required": 0, "plus_only": True,
                         "animated": True, "anim_class": "flag-anim-shimmer",
                         "css": "radial-gradient(circle at 82% 50%, rgba(255,255,255,.8) 0 2%, rgba(250,204,21,.9) 3%, transparent 18%), linear-gradient(90deg,#1c0a04 0%,#9a3412 28%,#f97316 54%,#fde047 78%,#fff7ed 100%)"},
    "codex_midnight_flag": {"name": "Midnight Library Flag", "price_coins": 520, "xp_required": 1800,
                            "css": "repeating-linear-gradient(90deg, rgba(255,122,61,.12) 0 2px, transparent 2px 34px), linear-gradient(90deg,#080A12 0%,#1A1A1F 44%,#2D2431 74%,#5B4694 100%)"},
    "codex_aurora_flag": {"name": "Exam Aurora Flag", "price_coins": 700, "xp_required": 2400,
                          "animated": True, "anim_class": "flag-anim-pan",
                          "css": "radial-gradient(ellipse at 18% 80%, rgba(0,155,114,.55), transparent 34%), radial-gradient(ellipse at 70% 20%, rgba(255,122,61,.38), transparent 32%), linear-gradient(90deg,#04130F 0%,#06352A 35%,#132039 65%,#30144A 100%)"},
