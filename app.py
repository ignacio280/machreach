...
def admin_jobs():
    ...
    <div class="admin-jobs">
      ...
      <div class="admin-panel">
        ...
        <div class="admin-note">Last heartbeat: <b>{_esc(worker_updated or 'never')}</b>. If this stops updating after a deploy, check the worker's logs and env vars (the <code>machreach-worker</code> service on Render, the <code>worker</code> container on the VPS).</div>
      </div>
